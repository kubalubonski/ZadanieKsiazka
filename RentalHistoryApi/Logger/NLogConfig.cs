...
public static class NLogConfig
{
    public static LoggingConfiguration ConfigureNLog()
    {
        ...
        fileTarget1.FileName = "C:\\Users\\Jakub Luboński\\Desktop\\ZadanieKsiazka\\RentalHistoryApi\\RentalHistoryApiLogs\\nlog-all-${shortdate}.log";
        ...
        //Rules
        config.LoggingRules.Add(new LoggingRule("RentalHistoryAPI*", NLog.LogLevel.Info, fileTarget1));
